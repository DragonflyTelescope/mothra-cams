...
def test_camera(exposure_time=0.01, gain=200, camera_type="color"):
    ...
    try:
        ...
        print(f"Capturing with {test_settings['exposure']}, gain {test_settings['gain']}")
        
        # Capture image
        image_data = obs_camera.capture_image(test_settings["exposure"], test_settings["gain"])
        ...
        if image_data is not None:
            ...
            print(f"   (Check your Docker compose mount configuration)")
